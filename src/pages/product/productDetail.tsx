  ...
  return (
    <div className="flex flex-col items-center w-full bg-white min-h-screen py-10">
      ...
      <div className="w-full max-w-6xl bg-white mt-6 p-10 rounded-lg flex">
        <div className="w-1/2 flex flex-col items-center">
          <img
            src={product.img}
            alt={product.name}
            className="w-[400px] h-[400px] rounded-lg shadow-md object-cover"
          />
          ...
          <div className="mt-6 flex gap-2">
            {[product.img, product.img, product.img].map((img, index) => (
              <img
                ...
                src={img}
                alt="썸네일"
                className="w-20 h-20 rounded-md border shadow-sm hover:opacity-80 cursor-pointer"
              />
            ))}
          </div>
        </div>
        ...
        <div className="w-1/2 pl-10">
          <h3 className="text-3xl font-extrabold text-gray-400 pb-2">
            [{product.brand}]
          </h3>
          ...
          <div className="bg-gray-100 p-4 rounded-lg mt-4">
            <div className="flex items-center gap-2">
              <button
                className="p-2 border rounded-md bg-gray-200 hover:bg-gray-300 text-lg"
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <p className="text-2xl font-extrabold text-black">
              {(product.price * quantity + shippingFee).toLocaleString()}원
            </p>
          </div>
      ...
      <div className="w-full max-w-6xl bg-white mt-10 p-10 rounded-lg text-center">
        {/* 상세 설명 페이지 */}
        <h2 className="text-3xl font-extrabold mt-4">상세설명 페이지</h2>
      </div>
        ...
        <div className="border-b pb-4 mb-6 flex items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <select
              ...
              onChange={(e) =>
                setReviewSort(
                  e.target.value as "최신순" | "별점높은순" | "별점낮은순"
                )
              }>
