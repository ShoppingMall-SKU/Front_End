...
interface inquiryWriteModal {
    onClose: () => void;
    onSubmit: (title: string, type: string, content: string, image: File|null) => void;
}

const InquiryWriteModal: React.FC<inquiryWriteModal> = ({onClose, onSubmit}) => {
    ...
    return (
        <ModalOverlay onClick={onClose}>
            <ModalContainer onClick={(e) => e.stopPropagation()}>
                ...
                <ButtonGroup>
                    <Button bgColor="black" onClick={handleSubmit}>문의작성</Button>
